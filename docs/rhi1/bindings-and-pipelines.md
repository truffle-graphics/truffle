...
storage-buffer words through a reflected ordinary bind group. These proofs
expand native backend slices but do not establish full backend conformance.
