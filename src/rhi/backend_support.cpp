...
constexpr std::array support{
    BackendPlatformSupport{BackendKind::null_validation, PlatformKind::all,
                           BackendMaturity::validation_only, false, validation_only,
    ...
    BackendPlatformSupport{BackendKind::vulkan, PlatformKind::linux_host,
                           BackendMaturity::native_smoke, true, validated_native_smoke,
                           "native buffers and selected 2D texture transfers "
                           "using bundled headers and volk"},
    BackendPlatformSupport{
        BackendKind::vulkan, PlatformKind::windows, BackendMaturity::source_only, true,
        source_only, "native loader source is present; no official runtime lane yet"},
    ...
    BackendPlatformSupport{BackendKind::direct3d12, PlatformKind::windows,
                           ...
                           "fences, queries, Win32/DXGI presentation, and exact output"},
